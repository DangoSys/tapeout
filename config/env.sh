...
export PRESIM_STAGE_DIR_NAME="${PRESIM_STAGE_DIR_NAME:-${POSTSIM_STAGE_DIR_NAME:-2_POSTSIM}}"
export POSTSIM_STAGE_DIR_NAME="${POSTSIM_STAGE_DIR_NAME:-$PRESIM_STAGE_DIR_NAME}"
...
if [ -n "${PROJECT_ROOT:-}" ]; then
  ...
  export PRESIM_STAGE_DIR="${PRESIM_STAGE_DIR:-${POSTSIM_STAGE_DIR:-$PROJECT_ROOT/$PRESIM_STAGE_DIR_NAME}}"
  export POSTSIM_STAGE_DIR="${POSTSIM_STAGE_DIR:-$PRESIM_STAGE_DIR}"
